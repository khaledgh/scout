...
export function AppLayout() {
  ...
  const pageTitle = pageTitles[location.pathname]
    ?? pageTitles[Object.keys(pageTitles).find((k) => k !== '/' && location.pathname.startsWith(k)) ?? '']
    ?? ''
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50 dark:bg-slate-950">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        {/* ── Topbar ───────────────────────────────────────── */}
        <header className="flex items-center gap-3 px-4 sm:px-6 h-14 sm:h-16 flex-shrink-0 bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800 shadow-sm z-30">
          {/* Hamburger */}
          <button
          ...
          {/* Page title */}
          <h2 className="font-bold text-gray-800 dark:text-slate-100 text-base sm:text-lg hidden sm:block" dir="rtl">
            {pageTitle}
          </h2>
          ...
          <div ref={notifsRef} className="relative">
            ...
            {showNotifs && (
              <div className="absolute left-0 top-11 sm:top-12 w-[min(320px,calc(100vw-1.5rem))] bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 z-50 overflow-hidden" dir="rtl">
          ...
          <div ref={userRef} className="relative">
            ...
            {showUser && (
              <div className="absolute left-0 top-11 sm:top-12 w-52 bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 z-50 overflow-hidden" dir="rtl">
